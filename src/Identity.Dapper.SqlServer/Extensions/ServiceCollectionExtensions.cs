...
using SandboxCore.Identity.Dapper.SqlServer.Connections;
using SandboxCore.Identity.Dapper.SqlServer.Models;
using SandboxCore.Identity.Dapper.Stores;
using SandboxCore.Identity.Dapper.UnitOfWork.Contracts;
...
namespace SandboxCore.Identity.Dapper.SqlServer
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IdentityBuilder AddDapperIdentityForSqlServer<TKey, TUserRole, TRoleClaim, TUserClaim, TUserLogin>(this IdentityBuilder builder)
        {
            builder.Services.AddSingleton<SqlConfiguration, SqlServerConfiguration>();
            builder.Services.AddScoped<IUnitOfWork, UnitOfWork.UnitOfWork>();
            builder.Services.TryAddSingleton(new DapperIdentityOptions());
            AddStores(builder.Services, builder.UserType, builder.RoleType, typeof(TKey), typeof(TUserRole), typeof(TRoleClaim), typeof(TUserClaim), typeof(TUserLogin));

            return builder;
        }

        public static IdentityBuilder AddDapperIdentityForSqlServer<TKey, TUserRole, TRoleClaim, TUserClaim, TUserLogin>(this IdentityBuilder builder, SqlServerConfiguration configurationOverride)
        {
            builder.Services.AddSingleton<SqlConfiguration>(configurationOverride);
            builder.Services.AddScoped<IUnitOfWork, UnitOfWork.UnitOfWork>();
            builder.Services.TryAddSingleton(new DapperIdentityOptions());
